...
import { getMyOrganization, createOrganization, updateMyHierarchy, updateMyOrganization } from "../controllers/organizations.controller.js";
...
router.put("/me", requireAuth, requireRole(ROLES.ADMIN), updateMyOrganization);
